...
# CK: does not seem to be used in model/anywhere
def r2(rf, X_train, y_train):
    return r2_score(y_train, rf.predict(X_train))

# moved below to imporst above:
# from sklearn.base import clone 

# CK: feature importance dataframe from Daniel
...
def train_and_test_model(feature_vectors, featureNames, labels,
  ...
  :param classifier_fct:
  :return:
  """
  # classifier = RandomForestRegressor(n_estimators=500)
  

  ### DT EDIT ### CK change - classifier_fct, added as param
...
def run():
  ...
  feature_vectors, featureNames, labels, feature_vectors_last_date, labels_last_date, feature_vectors_future = \
    ...
    # CK change - also put it as param for train_and_test_model
